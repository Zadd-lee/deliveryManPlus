        ...
        http
                ...
                .authorizeHttpRequests(auth->
                        auth
                                ...
                                .requestMatchers(UrlConst.ADMIN_INTERCEPTOR_LIST).hasRole("ADMIN")
                                .requestMatchers(UrlConst.OWNER_INTERCEPTOR_LIST).hasRole("OWNER")
                                .requestMatchers(UrlConst.CUSTOMER_INTERCEPTOR_LIST).hasRole("CUSTOMER")
